...
\pagebreak
\paragraph{Q3:} We create hybrid images by low-pass filtering a first image and combining it with a high-pass filtering of a second image. For (a--c), which filter does the kernel represent? For (d--e), which filter produced the output images?
